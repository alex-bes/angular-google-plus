 ...
 */
    provider('GooglePlus', [function () {
        ...
        this.setExtraLoginOptions = function (apiKey) {
            options.extraLoginOptions = apiKey;
            return this;
        };

        this.getExtraLoginOptions = function () {
            return options.extraLoginOptions;
        };
        ...
        this.$get = ['$q', '$rootScope', '$timeout', function ($q, $rootScope, $timeout) {
            ...
            NgGooglePlus.prototype.login = function () {
                ...
                Object.assign(authOptions, options.extraLoginOptions);
